...
<body class="hold-transition register-page">
  <div class="register-box">
    <div class="register-logo">
      <a href="../../index2.html"><b></b>Coffe Shop</a>
    </div>
    ...
    <div class="card">
      <div class="card-body register-card-body">
        ...
        <form action="{{ route('autoregistro') }}" method="post" enctype="multipart/form-data">
          {{ csrf_field()}}
          <div class="input-group mb-3">
            <input type="text" class="form-control" name="nombre" placeholder="Full name">
